...
/**
 * Adapter class for our search results RecyclerView.
 */
public class MovieSearchRecyclerViewAdapter extends RecyclerView.Adapter<MovieSearchRecyclerViewAdapter.SearchResultViewHolder> {
    ...
    public MovieSearchRecyclerViewAdapter(Context context, ArrayList<Movie> movies) {
    ...
    @NonNull
    @Override
    public MovieSearchRecyclerViewAdapter.SearchResultViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull MovieSearchRecyclerViewAdapter.SearchResultViewHolder holder, int position) {
