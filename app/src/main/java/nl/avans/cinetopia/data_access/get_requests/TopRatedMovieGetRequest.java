...
public class TopRatedMovieGetRequest extends AsyncTask<URL, Void, ArrayList<Movie>> {
    // Tag for logging.
    private static final String TAG = TopRatedMovieGetRequest.class.getSimpleName();

    // Listener attribute.
    private TopRatedMovieGetRequest.TopRatedMovieApiListener mListener;

    // Constructor.
    public TopRatedMovieGetRequest(TopRatedMovieGetRequest.TopRatedMovieApiListener listener) {
